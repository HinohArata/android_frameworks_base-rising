...
public class WeatherViewController implements OmniJawsClient.OmniJawsObserver {
    ...
    public WeatherViewController(Context context, ImageView weatherImageView, TextView weatherTextView) {
        mContext = context;
    ...
    public void updateWeatherSettings() {
        ...
        if (mWeatherTextView != null) {
            mWeatherTextView.setVisibility(mWeatherEnabled ? View.VISIBLE : View.GONE);
        }
        if (mWeatherEnabled) {
            enableUpdates();
        } else {
